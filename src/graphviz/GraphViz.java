...
//   private static String DOT = "D:/Program Files (x86)/Graphviz 2.28/bin/dot.exe";	// Windows
   ...
   private byte[] get_img_stream(File dot, String type)
   {
      ...
      try {
         ...
         if (normalInfo!=null){
        	 System.out.println("正常输出信息["+normalInfo+"]");
         }        
         

         BufferedReader   berrin   =   new   BufferedReader(new   InputStreamReader(p.getErrorStream()));         
         while((line   =   berrin.readLine())   !=   null) 
         { 
        	 errInfo += line;
         }
         
         if(errInfo != null){
        	 System.out.println("错误输出信息["+errInfo+"]");
         }        
         
         //System.out.print(" dot return valueis["+p.exitValue()+"]");
